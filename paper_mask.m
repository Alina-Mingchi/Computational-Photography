...
% y1 = lum1(1200:5:3900,2200:5:3900,2);
% lum2 = rgb2xyz(im2,'Colorspace','linear-rgb');
% y2 = lum2(1200:5:3900,2200:5:3900,2);
% lum3 = rgb2xyz(im3,'Colorspace','linear-rgb');
% y3 = lum3(1200:5:3900,2200:5:3900,2);
% lum4 = rgb2xyz(im4,'Colorspace','linear-rgb');
% y4 = lum4(1200:5:3900,2200:5:3900,2);
% lum5 = rgb2xyz(im5,'Colorspace','linear-rgb');
% y5 = lum5(1200:5:3900,2200:5:3900,2);
% lum6 = rgb2xyz(im6,'Colorspace','linear-rgb');
% y6 = lum6(1200:5:3900,2200:5:3900,2);
% lum7 = rgb2xyz(im7,'Colorspace','linear-rgb');
% y7 = lum7(1200:5:3900,2200:5:3900,2);
% lum8 = rgb2xyz(im8,'Colorspace','linear-rgb');
% y8 = lum8(1200:5:3900,2200:5:3900,2);
% lum9 = rgb2xyz(im9,'Colorspace','linear-rgb');
% y9 = lum9(1200:5:3900,2200:5:3900,2);
% lum10 = rgb2xyz(im10,'Colorspace','linear-rgb');
% y10 = lum10(1200:5:3900,2200:5:3900,2);
% 
% [r c] = size(y10);

mask = 0.0001 * ones(r,c);
mask(39:493,58:232) = ones;
y1 = mask.*y1;
y2 = mask.*y2;
y3 = mask.*y3;
y4 = mask.*y4;
...
y10 = mask.*y10;
% 
III = [y1(:)';y2(:)';y3(:)';y4(:)';y5(:)';y6(:)';y7(:)';y8(:)';y9(:)';y10(:)'];
save('III.mat','III')
% load('III.mat');
% r = 541;
% c = 341;
