...
%
% Author: Douglas Lanman and Gabriel Taubin, Brown University, 2/07
...
%       such as wrappers for the Matlab Calibration Toolbox.
addpath(genpath('./util'));
addpath(genpath('./TOOLBOX_calib'));

% Specify the demonstration parameters.
objName    = 'box';       % object name (should correspond to a data dir.)
seqName    = 'v1';         % sequence name (subdirectory of object)
calName    = 'cal';      % calibration source (also must be a data dir.)
